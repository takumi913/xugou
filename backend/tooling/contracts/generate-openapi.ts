...
const schemas: Record<string, Schema> = {
  ...
  ReleaseReadinessCheck: { type: "object", required: ["key", "ready", "actual", "threshold", "direction"], properties: { key: { type: "string" }, ready: { type: "boolean" }, actual: { type: ["number", "null"] }, threshold: { type: "number" }, direction: { type: "string", enum: ["maximum", "required"] } } },
  LegacyHistoryCoverage: { type: "object", required: ["source_table", "source_rows", "mapped_rows", "anomaly_rows", "read_ready", "conserved"], properties: { source_table: { type: "string" }, source_rows: { type: "integer" }, mapped_rows: { type: "integer" }, anomaly_rows: { type: "integer" }, read_ready: { type: "boolean" }, conserved: { type: "boolean" }, frozen: { type: "boolean" } } },
  ContractReleaseEvidence: { type: "object", required: ["id", "bundle_sha256", "release_version", "git_sha", "prepared_at", "activated_at", "digest_valid"], properties: { id: { type: ["string", "null"] }, bundle_sha256: { type: ["string", "null"] }, release_version: { type: ["string", "null"] }, git_sha: { type: ["string", "null"] }, prepared_at: { type: ["string", "null"] }, activated_at: { type: ["string", "null"] }, digest_valid: { type: "boolean" } } },
  ReleaseReadiness: { type: "object", required: ["generated_at", "release_version", "data_compatibility_mode", "contract_worker_ready", "contract_evidence", "release_ready", "credential_contract_ready", "management_v1_sunset_ready", "agent_v1_sunset_ready", "scheduler", "compatibility_windows", "legacy_history_coverage", "legacy_agent_model_coverage", "legacy_agent_current_metrics_coverage", "legacy_monitor_history_coverage", "legacy_monitor_daily_stats_coverage", "legacy_monitor_model_coverage", "legacy_notification_history_coverage", "legacy_status_page_coverage", "legacy_notification_rules_coverage", "legacy_notification_templates_coverage", "checks"], properties: { generated_at: { type: "string", format: "date-time" }, release_version: { type: "string" }, data_compatibility_mode: { type: "string", enum: ["expand", "contract"] }, contract_worker_ready: { type: "boolean" }, contract_evidence: { oneOf: [ref("ContractReleaseEvidence"), { type: "null" }] }, release_ready: { type: "boolean" }, credential_contract_ready: { type: "boolean" }, management_v1_sunset_ready: { type: "boolean" }, agent_v1_sunset_ready: { type: "boolean" }, scheduler: { type: "object", required: ["due_count", "oldest_due_at", "lag_seconds", "enqueued_last_minute", "enqueue_rate_per_second"], properties: { due_count: { type: "integer", minimum: 0 }, oldest_due_at: { type: ["string", "null"], format: "date-time" }, lag_seconds: { type: ["number", "null"], minimum: 0 }, enqueued_last_minute: { type: "integer", minimum: 0 }, enqueue_rate_per_second: { type: "number", minimum: 0 } } }, compatibility_windows: { type: "object", required: ["management_quiet_days", "management_hits", "agent_quiet_days", "agent_hits"], properties: { management_quiet_days: { type: "integer" }, management_hits: { type: "integer" }, agent_quiet_days: { type: "integer" }, agent_hits: { type: "integer" } } }, legacy_history_coverage: { type: "array", items: ref("LegacyHistoryCoverage") }, legacy_agent_model_coverage: ref("LegacyHistoryCoverage"), legacy_agent_current_metrics_coverage: ref("LegacyHistoryCoverage"), legacy_monitor_history_coverage: ref("LegacyHistoryCoverage"), legacy_monitor_daily_stats_coverage: ref("LegacyHistoryCoverage"), legacy_monitor_model_coverage: ref("LegacyHistoryCoverage"), legacy_notification_history_coverage: ref("LegacyHistoryCoverage"), legacy_status_page_coverage: ref("LegacyHistoryCoverage"), legacy_notification_rules_coverage: ref("LegacyHistoryCoverage"), legacy_notification_templates_coverage: ref("LegacyHistoryCoverage"), checks: { type: "array", items: ref("ReleaseReadinessCheck") } } },
  CompatibilityHit: { type: "object", required: ["day", "route_group", "method", "status_family", "hit_count", "first_seen_at", "last_seen_at", "last_release_version"], properties: { day: { type: "string", format: "date" }, route_group: { type: "string", enum: ["monitor_management_v1", "agent_management_v1", "agent_registration_v1", "agent_report_v1", "notification_management_v1", "status_v1"] }, method: { type: "string" }, status_family: { type: "string" }, hit_count: { type: "integer" }, first_seen_at: { type: "string", format: "date-time" }, last_seen_at: { type: "string", format: "date-time" }, last_release_version: { type: "string" } } },
